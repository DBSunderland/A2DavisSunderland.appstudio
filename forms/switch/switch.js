...
/*
The following code declares the variables 'name', 'state', and 'temperature'.
The variables are inputted by the user through a prompt statement.
The last variable 'messages' is an array which holds each of the messages that
will be displayed when the program runs.
*/
...
// i. all code must be indented properly
